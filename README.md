...
Projeto em grupo do curso **Programadores Cariocas**. Neste projeto desenvolvemos uma academia ficticia para aplicar as tecnologias desenvolvidas nesse modulo.

<h2 id="funcionalidades"> 🛠 Funcionalidades </h2>

* `Área do Administrador`: Sistema de matrículas feito com Event DOM JavaScript, validando o login e senha.
* `Matrícula`: Consumo da API para simular o uso de um banco de dados.
